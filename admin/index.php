...
<body>
                            ...
                            <form action="../config/proses_komentar.php" method="POST">
                              <div class="input-group">
                                ...
                                <div class="input-group-prepend">
                                  <button type="submit" name="kirimkomentar" class="btn btn-outline-primary"><i class="bi bi-send-plus-fill"></i></button>
                                </div>
                              </div>
                            </form>
                          </div>
  ...
  <footer class="d-flex justify-content-center border-top mt-2 fixed-bottom bg-dark">
